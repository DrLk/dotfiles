require('vgit').setup({
  keymaps = {
    ['n [c'] = function() require('vgit').hunk_up() end,
    {
      mode = 'n',
      key = ']c',
      handler = 'hunk_down',
    ...
    ['n <leader>hf'] = function() require('vgit').buffer_diff_preview() end,
    ['n <leader>hh'] = function() require('vgit').buffer_history_preview() end,
    ['n <leader>hu'] = function() require('vgit').buffer_reset() end,
    ['n <leader>hd'] = function() require('vgit').project_diff_preview() end,
    ['n <leader>hx'] = function() require('vgit').toggle_diff_preference() end,
  },
  settings = {
